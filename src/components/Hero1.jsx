...
const Hero1 = () => {
  return (
    <div className="flex justify-center self-stretch py-10 md:py-20">
      <div className="w-xs md:w-2xl lg:w-5xl flex flex-col items-start gap-x-7 gap-y-10 md:flex-row md:gap-y-0">
        <div className="flex flex-1 flex-col items-center gap-y-10 md:gap-y-5 lg:gap-y-7">
          ...
          <a href="signup" className="self-stretch md:self-start">
            <button className="animation bg-cta flex h-14 w-full items-center justify-center rounded-3xl px-12  font-semibold active:translate-y-1">
